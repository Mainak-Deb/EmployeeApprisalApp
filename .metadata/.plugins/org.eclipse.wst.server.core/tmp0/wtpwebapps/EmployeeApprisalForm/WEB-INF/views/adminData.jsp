...
<div id="afterData">
  <div class="employee">
    <div class="employee_detail">Employee Name :</div>
    <div class="employee_count">${employeeDetails.name}</div>
  </div>
  <div class="employee">
    <div class="employee_detail">Employee CTC :</div>
    <div class="employee_count">${employeeDetails.ctc}</div>
  </div>
  <div class="employee">
    <div class="employee_detail">Employee Level :</div>
    <div class="employee_count">${employeeDetails.level}</div>
  </div>
  <div class="employee">
    <div class="employee_detail">Employee designation :</div>
    <div class="employee_count">${employeeDetails.designation}</div>
  </div>
  <div class="employee">
    <div class="employee_detail">Employee email :</div>
    <div class="employee_count">${employeeDetails.username}</div>
  </div>
  ...
  <div class="employee_date">
    <div class="datediv">
      ...
      <input
        ...
        id="joiningDate"
        name="joiningDate"
        value="${employeeDetails.postedDate}"
        disabled
      />
    </div>
    <div class="datediv">
      <label for="ProcessedDate">Processed Date:</label><br />
      <input
        type="text"
        class="input_box"
        id="ProcessedDate"
        name="ProcessedDate"
        value="${employeeDetails.processedDate}"
        disabled
      />
    </div>
  </div>
    ...
    <div class="modal-content">
      ...
      <form id="employeeForm">
        ...
        <select id="level" name="level" required>
          ...
          <c:forEach
            begin="${Math.min(employeeDetails.level.substring(1)+1,9)}"
            end="9"
            var="level"
          >
        ...
        <button style="margin: 10px 220px" onclick="updateDatabaseYes()">
          Update
        </button>
      </form>
    </div>
    ...
    <div class="modal-content">
      ...
      <div class="modalpart">
        ...
        <span style="color: rebeccapurple">
          <span id="basicper">0</span> % incremented</span
        >
        <br />
        <label>
          <input
            ...
            name="section1"
            value="medical"
            onclick="enableSection2('medical')"
          />
          Medical </label
        ><input
          type="text"
          id="medicalSalary"
          value="${employeeDetails.medical}"
          disabled
        />
        <span style="color: rebeccapurple">
          <span id="medicalper">0</span> % incremented</span
        >
        <br />
        <label>
          <input
            ...
            name="section1"
            value="special"
            onclick="enableSection2('special')"
          />
          Special Allowance </label
        ><input
          type="text"
          id="specialSalary"
          value="${employeeDetails.specialAllowances}"
          disabled
        />
        <span style="color: rebeccapurple">
          <span id="saper">0</span> % incremented</span
        >
        <br />
        ...
        <div id="sectionIndicator2" style="display: none">
          ...
          <form>
            ...
            <input
              ...
              id="manualInput2"
              style="display: none"
              onchange="manualChange2()"
            />
          </form>
        </div>
      </div>
      <button style="margin: 10px 220px" onclick="updateDatabaseNo()">
        Update
      </button>
    </div>
  </div>
...
<script>
  ...
  function enableSection3(selection) {
    ...
    var sectionNameIndicator = document.getElementById("sectionNameIndicator2");
    backToDefault2();
